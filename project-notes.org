...
- The src_rust{pub struct ViewModel {}} exposes its data via src_rust{pub}. Is this an Adapter?
- The src_rust{pub struct Capabilies {}} exposes its data via src_rust{pub}. Is this an Adapter?
- All else have src_rust{pub struct {}} only. Is this a Port?
